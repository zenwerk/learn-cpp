...
private:
    ...
    bool state_3(token_type token, const value_type& value) {
        ...
        case token_eof:
            // reduce
            return call_0_Greet(Nonterminal_HelloWorld, /*pop*/ 2, 0, 1);
        default:
            sa_.syntax_error();
            error_ = true;
            return false;
